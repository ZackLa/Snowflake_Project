...
Before execute the follow code. You need to go to the terminal to execute

snowflake -a "accountname" -u "username"
-- acount name is associated on url.
then you should be asked to type your password


PUT file:///Users/zackhung/Desktop/Learning_Related/Python/Project/Snowflake/Dataset/Otodom_Apartment_major_cities_dataset_Address.csv @my_csv_stage;
...
FROM (
    SELECT $1
      ,$2 
      ,$3 
   FROM @my_csv_stage/Otodom_Apartment_major_cities_dataset_Address.csv.gz
);
...
PUT file:///Users/zackhung/Desktop/Learning_Related/Python/Project/Snowflake/Dataset/Otodom_Apartment_major_cities_dataset_Translate.csv @MY_CSV_STAGE_TRANS;
...
PUT file:///Users/zackhung/Desktop/Learning_Related/Python/Project/Snowflake/Dataset/Otodom_Apartment_major_cities_dataset_Flatten.csv @MY_CSV_STAGE_ORG;
...
SELECT * FROM OTODOM_DATA_ADDRESS; 
SELECT * FROM OTODOM_DATA_TRANSLATE; 
SELECT * FROM OTODOM_DATA limit 30;
...
select count(1) from OTODOM_DATA_TRANSFORMED; -- 62,802
