...
8) Which are the top 3 most luxurious neighborhoods in Warsaw? Luxurious neighborhoods can be defined as 
suburbs which has the most no of of apartments costing over 2M in cost.
...
12) How many apartment are there for different range of average rental price at capital Warszawa?

	with cte as (
	select city, price_new
	,case when price_new between 1000 and 2000 then '1k~2k'
